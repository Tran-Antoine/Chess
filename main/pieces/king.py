...
class King(gamepiece.Piece):
    ...
    def moves_available(self, board):
        ...
        for i in [-1, 0, 1]:
            for j in [-1, 0, 1]:
                ...
                if ImaginaryBoard.location_on_board(next_position) and board.can_move_at_location(next_position, self.color):
    ...
    def add_castling_move(self, rook: dirpieces.Rook, board: ImaginaryBoard, moves: List[movedata.MoveData]):
